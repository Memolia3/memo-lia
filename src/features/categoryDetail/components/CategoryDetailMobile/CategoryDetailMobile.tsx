...
import { CategoryDetailMobileProps, GenreData } from "../../types";
      ...
      <main className="flex-1 overflow-auto px-4 py-6 sm:px-6 sm:py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            ...
            <Typography as="p" variant="body-sm" color="muted" className="mb-3">
              {t("genres.description")}
            </Typography>

            {isLoading ? (
              <div className="text-center py-6 text-gray-500 dark:text-gray-400">読み込み中...</div>
            ) : (
              <GenreGrid
                genres={genres}
