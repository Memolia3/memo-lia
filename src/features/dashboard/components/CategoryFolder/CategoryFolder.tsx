...
import { NOTIFICATION_MESSAGES, getNotificationMessage } from "@/constants/notification";
 ...
 * 各カテゴリをフォルダ形式で表示
 */
export const CategoryFolder: React.FC<CategoryFolderProps> = memo(
  ({ category, onClick, className, onDelete }) => {
      ...
      try {
        ...
        addNotification({
          ...
          message: getNotificationMessage(
            NOTIFICATION_MESSAGES.SUCCESS.CATEGORY_DELETED,
            getCurrentLocale()
          ),
          duration: 3000,
        });
        ...
        addNotification({
          type: "error",
          message: getNotificationMessage(
            NOTIFICATION_MESSAGES.SUCCESS.CATEGORY_DELETE_ERROR,
            getCurrentLocale()
          ),
          duration: 5000,
        });
